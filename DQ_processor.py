...
if __name__ == "__main__":
    ...
    for episode in range(num_episodes):
        ...
        if episode % 100 == 0:
            ...
            print(f"Episode {episode+1}/{num_episodes}, Total Avg.Reward: {np.mean(env.all_rewards):.2f}, Recent Avg. Reward: {past_100_avg_rewards:.2}, Epsilon: {epsilon:.3f}")
            env.plot_rewards(save=True, model_type="DQN")

    env.plot_avg_rewards(env.all_rewards, save=True)
